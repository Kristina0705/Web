...
Листинг App.vue представлен в приложении А</p>
...
<p>В процессе работы был сформирован Vue пакет под названием vue-master(Приложение А), куда были добавлены компоненты из других пакетов(Приложение Б, В, Г). 
...
<p align="center">Листинг компонента App.vue</p>
<p><template>
  <header v-flex="''">
    <user-info />
    <login-form />
...
@font-face {
  ...
  font-weight: 400;
  font-display: swap;
  src: url(/src/assets/fonts/Lobster-Regular.ttf) format("truetype");
}
* {
  margin: 0;
  padding: 0;
